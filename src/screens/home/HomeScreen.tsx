...
const styles = StyleSheet.create({
  ...
  activityGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', rowGap: 10 },
  activityCard: { width: '48.6%', borderRadius: 20, borderWidth: 1, borderColor: '#5E5578', backgroundColor: '#17112F', padding: 12 },
